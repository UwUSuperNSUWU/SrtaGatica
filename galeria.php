...
<div class="container">
    ...
    <div class="row">
        ...
        $casas = [
            ...
            ["id" => 3, "titulo" => "Terreno Sector Urbano", "imagen" => "img/terrenos/parcela_challaco/exterior 4.PNG", "descripcion" => "TERRENO EN SECTOR CHALLACO...Curacaví. 440 MTRS CUADRADOS", "precio" => 26000000],
            ["id" => 4, "titulo" => "Casa 275mts cuadrados Sector urbano ", "imagen" => "img/terrenos/terreno_sector_urbano/exterior 2.PNG", "descripcion" => "TERRENO (CESIÓN DE DERECHOS)...275 METRO CUADRADOS", "precio" => 58000000],
